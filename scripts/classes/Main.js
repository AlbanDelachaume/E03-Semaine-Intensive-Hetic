	...
	eliminatePlanet(planetEliminate, newPlanet) {
		...
		planetEliminate.addEventListener('click', () => {
			...
			if (this.checkGameOver()) {
				txt.innerText = "Désolé, tu n’as pas trouvé notre prochaine planète ! Réessaye, la prochaine fois sera la bonne. N’hésite pas à relire mes conseils. Mais n’oublie pas que la meilleure planète reste la notre et qu’il faut tout faire la préserver. "
			} else {
				txt.innerText = `Bien joué, tu as trouvé notre prochaine planète ! Nous savons à présent où aller quand toutes les ressource de notre planètes seront épuisés. Mais n’oublie pas que la meilleure planète reste la notre et qu’il faut tout faire la préserver. Si tu désire en savoir plus, n’hésitez pas à lire notre cours plus détaillé.`
			}
